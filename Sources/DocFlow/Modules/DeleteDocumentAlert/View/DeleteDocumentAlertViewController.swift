//
//  DeleteDocumentAlertViewController.swift
//
//
...
protocol DeleteDocumentAlertDelegate: AnyObject {
    func deleteDocument()
}

class DeleteDocumentAlertViewController: UIViewController, DeleteDocumentAlertViewInput {

    var output: DeleteDocumentAlertViewOutput?
    weak var delegate: DeleteDocumentAlertDelegate?
    ...
    private lazy var subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Document “Договор на оказание услуг по разработке” will be deleted."
