//
//  EmptyInitiatorAlertViewController.swift
//
//
...
protocol EmptyInitiatorAlertDelegate: AnyObject {
    func saveAsDraft()
}

class EmptyInitiatorAlertViewController: UIViewController, EmptyInitiatorAlertViewInput {

    var output: EmptyInitiatorAlertViewOutput?
    weak var delegate: EmptyInitiatorAlertDelegate?
    ...
    private lazy var subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = "You should have at least one signatory to send the document"
    ...
    private lazy var saveButton: UIButton = {
        let button = UIButton()
        button.setTitle("Back to editing", for: .normal)
    ...
    private lazy var notSaveButton: UIButton = {
        let button = UIButton()
        button.setTitle("Save as draft", for: .normal)
    ...
    private func setupViews() {
        ...
        [saveButton, notSaveButton].forEach {
